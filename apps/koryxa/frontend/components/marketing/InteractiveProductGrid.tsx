          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`rounded-xl px-3.5 py-2 text-xs font-bold transition duration-200 ${
                  isSelected
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex h-13 w-13 items-center justify-center rounded-2xl border border-black/5 bg-[#00a86b]/10 text-[#00a86b] transition duration-300 group-hover:bg-[#00a86b] group-hover:text-white shadow-sm dark:border-white/10 dark:bg-[#00a86b]/20 dark:text-[#4ade80]">
                      <Icon className="h-6 w-6" />
                    </div>
                    <span className="rounded-full bg-[#00a86b]/15 px-3 py-1 text-[11px] font-bold text-[#008b58] border border-[#00a86b]/30 dark:bg-[#00a86b]/20 dark:text-[#86efac]">
                  ...
                  {/* Summary */}
                  <p className="mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300 line-clamp-3 leading-relaxed text-center sm:text-left">
                    {product.summary}
                  </p>

                  {/* Target Audience Pill */}
                  <div className="mt-4 rounded-xl border border-slate-100 bg-slate-50 p-2.5 dark:border-white/10 dark:bg-white/5">
                ...
                {/* Actions */}
                <div className="mt-6 pt-4 border-t border-slate-100 dark:border-white/10 flex flex-col sm:flex-row items-center gap-2">
                  <a
                    href={product.href}
                    target="_blank"
                    rel="noreferrer"
