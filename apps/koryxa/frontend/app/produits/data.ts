...
export const productCatalog: Record<string, ProductInfo> = {
  ...
  cora: {
    slug: "cora",
    name: "Cora",
    tagline: "Cockpit IA modulaire pour organiser assistants et agents opérationnels.",
    summary:
      "Cora organise vos assistants IA et vos agents opérationnels dans un cockpit de travail unifié. Choisissez un espace, ajoutez le contexte utile, obtenez des résultats précis et gardez le contrôle sur les actions sensibles.",
    audience: "Équipes, managers, créateurs, freelances et entreprises",
    status: "actif",
    href: "https://cora.koryxa.fr",
    badge: "Cockpit IA Modulaire",
    category: "Automatisation & CRM",
    stats: [
      { label: "Vue Cockpit", value: "6 Espaces" },
      { label: "Assistants IA", value: "3 Dédiés" },
      { label: "Agents", value: "2 Opérationnels" },
    ],
    highlights: [
      "Cockpit centralisé & 6 espaces modulaires",
      "Assistants IA & Agents opérationnels intégrés",
      "Gouvernance et validation des actions sensibles",
    ],
    primaryCta: { label: "Ouvrir Cora", href: "https://cora.koryxa.fr" },
    secondaryCta: { label: "Explorer les espaces", href: "https://cora.koryxa.fr" },
    useCases: [
      "Répondre aux clients avec des assistants IA",
      "Exploiter et synthétiser des documents",
      "Superviser les actions opérationnelles sensibles",
    ],
    simulatorType: "crm-autopilot",
    techSpecs: {
      protocol: "Cockpit Next.js & Modèles IA Souverains",
      deployment: "Cloud Souverain KORYXA",
      latency: "Temps réel streaming",
      security: "Contrôle et validation humaine des actions sensibles",
      integrations: ["Documents (PDF, TXT)", "Assistants IA", "Compte KORYXA"],
    },
  },
  "services-ia": {
    slug: "services-ia",
