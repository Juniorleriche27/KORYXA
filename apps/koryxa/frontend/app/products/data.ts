...
export const productCatalog: Record<string, ProductInfo> = {
  chatlaya: {
    ...
    status: "actif",
    repo: "Juniorleriche27/koryxa-chatlaya",
    href: "https://github.com/Juniorleriche27/koryxa-chatlaya",
    stats: [{ label: "Accès", value: "1" }, { label: "Mode", value: "IA" }, { label: "Statut", value: "Actif" }],
    highlights: ["Conversation IA", "Cadrage", "Espace autonome"],
    primaryCta: { label: "Découvrir", href: "https://github.com/Juniorleriche27/koryxa-chatlaya" },
  ...
  cora: {
    ...
    status: "actif",
    repo: "Juniorleriche27/koryxa-cora",
    href: "https://github.com/Juniorleriche27/koryxa-cora",
    ...
    primaryCta: { label: "Découvrir", href: "https://github.com/Juniorleriche27/koryxa-cora" },
  ...
  "partner-portal": {
    ...
    status: "actif",
    repo: "Juniorleriche27/koryxa-partner-portal",
    href: "https://github.com/Juniorleriche27/koryxa-partner-portal",
    ...
    primaryCta: { label: "Accéder", href: "https://github.com/Juniorleriche27/koryxa-partner-portal" },
  ...
  api: {
    ...
    status: "interne",
    repo: "Juniorleriche27/koryxa-api",
    href: "https://github.com/Juniorleriche27/koryxa-api",
    stats: [{ label: "Couche", value: "API" }, { label: "Usage", value: "Interne" }, { label: "Statut", value: "Actif" }],
    highlights: ["API", "Intégrations", "Systèmes"],
    primaryCta: { label: "Voir l’API", href: "https://github.com/Juniorleriche27/koryxa-api" },
  ...
  formation: {
    ...
    status: "actif",
    repo: "Juniorleriche27/koryxa_formation",
    href: "https://github.com/Juniorleriche27/koryxa_formation",
    ...
    primaryCta: { label: "Découvrir", href: "https://github.com/Juniorleriche27/koryxa_formation" },
  ...
  neurokap: {
    ...
    status: "actif",
    repo: "Juniorleriche27/neurokap",
    href: "https://github.com/Juniorleriche27/neurokap",
    stats: [{ label: "Projet", value: "IA" }, { label: "Mode", value: "Autonome" }, { label: "Statut", value: "Actif" }],
    highlights: ["Projet IA", "Autonomie", "Écosystème"],
    primaryCta: { label: "Découvrir", href: "https://github.com/Juniorleriche27/neurokap" },
  ...
  corabiz: {
    ...
    status: "actif",
    repo: "Juniorleriche27/corabiz",
    href: "https://github.com/Juniorleriche27/corabiz",
    ...
    primaryCta: { label: "Découvrir", href: "https://github.com/Juniorleriche27/corabiz" },
  ...
  "services-ia": {
    ...
    status: "actif",
    repo: "Juniorleriche27/koryxa-services-ia",
    href: "https://github.com/Juniorleriche27/koryxa-services-ia",
    ...
    primaryCta: { label: "Découvrir", href: "https://github.com/Juniorleriche27/koryxa-services-ia" },
